...
*/}}
{{- define "khulnasoft.ingress.apiVersion" -}}
{{- if .Values.ingress.apiVersion -}}
{{- .Values.ingress.apiVersion -}}
{{- else if semverCompare "<1.14-0" (include "khulnasoft.kubeVersion" .) -}}
{{- "extensions/v1beta1" -}}
{{- else if semverCompare "<1.19-0" (include "khulnasoft.kubeVersion" .) -}}
...
*/}}
{{- define "khulnasoft.restarter.enabled" -}}
...
*/}}
{{- define "khulnasoft.parent.configs.configmap" -}}
...
*/}}
{{- define "khulnasoft.child.configs.configmap" -}}
...
*/}}
{{- define "khulnasoft.k8sState.configs.configmap" -}}
...
*/}}
{{- define "khulnasoft.parent.configs.secret" -}}
{{- range $name, $config := .Values.parent.configs -}}
...
*/}}
{{- define "khulnasoft.child.configs.secret" -}}
{{- range $name, $config := .Values.child.configs -}}
{{- if and $config.enabled (eq $config.storedType "secret") }}
{{ $name }}: {{ tpl $config.data $ | b64enc }}
{{- end -}}
...
*/}}
{{- define "khulnasoft.k8sState.configs.secret" -}}
{{- range $name, $config := .Values.k8sState.configs -}}
{{- if and $config.enabled (eq $config.storedType "secret") }}
{{ $name }}: {{ tpl $config.data $ | b64enc }}
{{- end -}}
